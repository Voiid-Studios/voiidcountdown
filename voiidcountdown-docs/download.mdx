    ...
    const load = async () => {
      try {
        ...
        if (!cancelled) {
          ...
          setLite((prev) => ({ ...prev, ...errorState }));
          setFull((prev) => ({ ...prev, ...errorState }));
          setLiteBeta((prev) => ({ ...prev, ...errorState }));
          setFullBeta((prev) => ({ ...prev, ...errorState }));
        }
      }
    };
  ...
  return (
    <div className="downloads-page">
      ...
      <div className="toggle-container">
        <button
          className={`btn toggle ${showExperimental ? 'active' : ''}`}
        ...
        <div className="plan experimental">
          <h2>Lite Experimental (Datapack)</h2>
            ...
            <div className="btns">
              <a
                id="lite-predownload"
                className="btn primary-experimental"
                href={lite.downloadUrl}
                target="_blank"
                rel="noopener noreferrer"
              >
