...
execute if score LanguageTimer Timer matches 0 if score McVersionToNBTNew Timer matches 3.. run tellraw @s ["-------------------------------------\n",{"text":"Voiid Countdown Timer","bold":true,"color":"light_purple"}," ",{"text":"cambiar el idioma, utiliza o clickea el\ncomando para obtener el libro:","color":"green"},"\n",{"text":"/function vct:book","bold":true,"color":"aqua","click_event":{"action":"run_command","command":"/function vct:book"},"hover_event":{"action":"show_text","value":"Haz clic aquí para ejecutar este comando!"}},"\n-------------------------------------"]
execute if score LanguageTimer Timer matches 0 if score McVersionToNBTNew Timer matches ..2 run tellraw @s ["-------------------------------------\n",{"text":"Voiid Countdown Timer","color":"light_purple","bold":true}," ",{"text":"se ha recargado para\ncambiar el idioma, utiliza o clickea el\ncomando para obtener el libro:","color":"green"},"\n",{"text":"/function vct:book","bold":true,"clickEvent":{"action":"run_command","value":"/function vct:book"},"hoverEvent":{"action":"show_text","contents":"Haz clic aquí para ejecutar este comando!"},"color":"aqua"},"\n-------------------------------------"]
