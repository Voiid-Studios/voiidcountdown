...
execute if score InstalledOneTime Timer matches 0 if score McVersionToNBTNew Timer matches 1 run tellraw @a [{"text":"■","bold":false,"color":"aqua"},{"text":" VCT: ","bold":true,"color":"aqua"},{"text":"Using new NBT tags (1.20.5+)","bold":false,"color":"aqua"}]
